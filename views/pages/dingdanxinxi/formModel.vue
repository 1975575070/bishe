	...
	<div class="detail-page">
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">购买者账号</div>

					<div  class="info_text" >{{detail.goumaizhezhanghao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">购买者姓名</div>

					<div  class="info_text" >{{detail.goumaizhexingming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('dingdanxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('dingdanxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('dingdanxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
